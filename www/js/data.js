...
const PRODUCTS = [
  { id: 1, title: 'Fresh Palak', titleEn: 'Fresh Spinach', titleHi: 'Taza Palak', price: 20, unit: 'gaddi', seller: 'ramesh', category: 'sabzi', stock: 25 },
  { id: 2, title: 'Gobi', titleEn: 'Cauliflower', titleHi: 'Bandh Gobi', price: 40, unit: 'pcs', seller: 'ramesh', category: 'sabzi', stock: 15 },
  { id: 3, title: 'Tamatar', titleEn: 'Tomatoes', titleHi: 'Desi Tamatar', price: 30, unit: 'kg', seller: 'ramesh', category: 'sabzi', stock: 35 },
  { id: 4, title: 'Doodh', titleEn: 'Milk', titleHi: 'Taza Doodh', price: 60, unit: 'litre', seller: 'suresh', category: 'dairy', stock: 50 },
  { id: 5, title: 'Dahi', titleEn: 'Yogurt', titleHi: 'Makhan Dahi', price: 50, unit: 'kg', seller: 'suresh', category: 'dairy', stock: 20 },
  { id: 6, title: 'Paneer', titleEn: 'Paneer', titleHi: 'Taza Paneer', price: 90, unit: '200g', seller: 'suresh', category: 'dairy', stock: 15 },
  { id: 7, title: 'Aashirvaad Atta', titleEn: 'Aashirvaad Atta', titleHi: 'Atta', price: 45, unit: 'kg', seller: 'kavita', category: 'kirana', stock: 100 },
  { id: 8, title: 'Chini', titleEn: 'Sugar', titleHi: 'Madhur Chini', price: 42, unit: 'kg', seller: 'kavita', category: 'kirana', stock: 80 },
  { id: 9, title: 'Aam', titleEn: 'Mango', titleHi: 'Ratnagiri Aam', price: 80, unit: 'dozen', seller: 'mohan', category: 'fruit', stock: 30 },
  { id: 10, title: 'Kela', titleEn: 'Banana', titleHi: 'Bhuvel Kela', price: 40, unit: 'dozen', seller: 'mohan', category: 'fruit', stock: 40 },
  { id: 11, title: 'Banarasi Silk Saree', titleEn: 'Banarasi Silk Saree', titleHi: 'Banarasi Saree', price: 2500, unit: 'pcs', seller: 'neeta', category: 'clothes', stock: 8 },
  { id: 12, title: 'Cotton Kurta', titleEn: 'Cotton Kurta', titleHi: 'Suthan Kurta', price: 450, unit: 'pcs', seller: 'neeta', category: 'clothes', stock: 20 },
  { id: 13, title: 'Designer Dupatta', titleEn: 'Designer Dupatta', titleHi: 'Designar Dupatta', price: 350, unit: 'pcs', seller: 'neeta', category: 'clothes', stock: 15 },
  { id: 14, title: 'Anarkali Suit', titleEn: 'Anarkali Suit', titleHi: 'Anarkali Suit', price: 1200, unit: 'pcs', seller: 'arjun', category: 'clothes', stock: 12 },
  { id: 15, title: 'Palazzo Set', titleEn: 'Palazzo Set', titleHi: 'Palajo Set', price: 600, unit: 'set', seller: 'arjun', category: 'clothes', stock: 18 },
  { id: 16, title: 'Lehenga', titleEn: 'Lehenga', titleHi: 'Designar Lehenga', price: 3500, unit: 'pcs', seller: 'arjun', category: 'clothes', stock: 5 },
  { id: 17, title: 'Custom Blouse', titleEn: 'Custom Blouse', titleHi: 'Blouse Silai', price: 250, unit: 'pcs', seller: 'seema', category: 'clothes', stock: 10 },
  { id: 18, title: 'Suit Stitching', titleEn: 'Suit Stitching', titleHi: 'Suit Silai', price: 400, unit: 'pcs', seller: 'seema', category: 'clothes', stock: 8 },
  { id: 19, title: 'Mobile Cover', titleEn: 'Mobile Cover', titleHi: 'Mobile Kaver', price: 150, unit: 'pcs', seller: 'rajesh', category: 'electronics', stock: 50 },
  { id: 20, title: 'Earphones', titleEn: 'Earphones', titleHi: 'Iarphon', price: 299, unit: 'pcs', seller: 'rajesh', category: 'electronics', stock: 30 },
  { id: 21, title: 'Power Bank', titleEn: 'Power Bank', titleHi: 'Pavar Bank', price: 500, unit: 'pcs', seller: 'rajesh', category: 'electronics', stock: 20 },
  { id: 22, title: 'Mehendi Service', titleEn: 'Mehendi Service', titleHi: 'Mehandi', price: 200, unit: 'session', seller: 'poonam', category: 'beauty', stock: 10 },
  { id: 23, title: 'Facial', titleEn: 'Facial', titleHi: 'Feshal', price: 300, unit: 'session', seller: 'poonam', category: 'beauty', stock: 8 },
  { id: 24, title: 'Threading', titleEn: 'Threading', titleHi: 'Threading', price: 50, unit: 'session', seller: 'poonam', category: 'beauty', stock: 20 },
  { id: 25, title: 'AC Repair', titleEn: 'AC Repair', titleHi: 'AC Repair', price: 500, unit: 'visit', seller: 'deepak', category: 'services', stock: 5 },
  { id: 26, title: 'Plumbing', titleEn: 'Plumbing', titleHi: 'Nal Repair', price: 300, unit: 'visit', seller: 'deepak', category: 'services', stock: 8 },
  { id: 27, title: 'Full Time Maid', titleEn: 'Full Time Maid', titleHi: 'Poori naukarani', price: 8000, unit: 'month', seller: 'household', category: 'services', stock: 3 },
  { id: 28, title: 'Part Time Maid', titleEn: 'Part Time Maid', titleHi: 'Aadhi naukarani', price: 4000, unit: 'month', seller: 'household', category: 'services', stock: 5 },
  { id: 29, title: 'Cook', titleEn: 'Cook', titleHi: 'Rasiya', price: 6000, unit: 'month', seller: 'household', category: 'services', stock: 2 },
  { id: 30, title: 'Baby Caretaker', titleEn: 'Baby Caretaker', titleHi: 'Baccho ki dekhbhal', price: 5000, unit: 'month', seller: 'household', category: 'services', stock: 2 },
  { id: 31, title: 'Elderly Caretaker', titleEn: 'Elderly Caretaker', titleHi: 'Buzurgo ki dekhbhal', price: 5500, unit: 'month', seller: 'household', category: 'services', stock: 2 },
];
